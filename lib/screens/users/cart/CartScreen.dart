...
class CartPage extends GetView<CartController> {
                                    ...
                                    child: Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          if (model.proCode != null)
                                            Text(
                                              model.proCode!.isEmpty
                                                  ? ""
                                                  : "code: ${model.proCode}",
                                              textAlign: TextAlign.left,
                                              style: const TextStyle(
  ...
  _buildAddressListDialog() async {
    ...
    if (controller.addressList.isNotEmpty) {
      ...
      showSnackBarWithText(Get.context, "Please add address first!");
      Get.to(() => AddressListPage(
            isWithAddAddressDialog: true,
          ));
    }
  }
}
