...
class DashBoardPage extends GetView<DashBoardController> {
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      actions: [
        Obx(() =>
        !DashBoardController.isGuest.value
            ? InkWell(
          onTap: () {
            Get.to(() => CartPage());
          },
            ...
            Drawer(
              child: Column(
                ...
                children: [
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        children: [
                          ...
                          Column(
                            children: [
                              if (!DashBoardController.isGuest.value)
                                ListTile(
                                  onTap: () {
                                    if (controller.keyScaffold.currentState !=
                                        null) {
                  ...
                  if (!isAdminLogin && !DashBoardController.isGuest.value)
                    Divider(
                      color: colorPrimary.shade100,
                      endIndent: 10,
                      indent: 50,
